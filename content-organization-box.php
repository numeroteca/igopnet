...
<article id="post-<?php the_ID(); ?>" <?php post_class('col-md-4 directory-box'); ?>>
	<div class="panel panel-default">
		<div class="row panel-body">
			<div class="col-md-4">
				<small>Google Page Rank</small>
				<div class="progress">
					<div class="progress-bar" role="progressbar" aria-valuenow="2" aria-valuemin="0" aria-valuemax="100" title="Google Page Rank <?php echo $google_page_rank; ?>" style="width:<?php echo 100*$google_page_rank/9; ?>%;">
				...
				<small>
					<?php
					if ($last_url_item['alexa_page_rank'] != 0) {
						echo "Alexa Page Rank:<br/>". number_format($last_url_item['alexa_page_rank'], 0, ',', '.'). "<br/>";
					}
					if (!empty($twitter_info)) { //if twitter in time info is not empty
						if ($twitter_info[0]['followers'] != '') { //if the number of followers is available
							echo "Twitter Followers:<br/>". number_format($twitter_info[0]['followers'], 0, ',', '.');
						}
					} ?>
				</small>
			</div>
			<div class="col-md-8">
				...
				?><br/>
				<?php
				echo !($twitter_account=='') ? "<a href='https://twitter.com/".$twitter_account. "' title='Twitter'><img src='".get_stylesheet_directory_uri()."/img/twitter_logo.png' alt='Twitter'></a> " : "" ;
				echo !($facebook_site=='') ? "<a href='https://facebook.com/".$facebook_site. "' title='Facebook'><img src='".get_stylesheet_directory_uri()."/img/facebook_logo.png' alt='Facebook'></a > " : "";
				echo !($youtube_account=='') ? "<a href='https://youtube.com/".$youtube_account."' title='Youtube'><img src='".get_stylesheet_directory_uri()."/img/youtube_logo.png' alt='YouTube'></a>" : "";
				?>
			</div>
		</div>
	</div>
